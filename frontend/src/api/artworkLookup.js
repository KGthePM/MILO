...
//
// Reuses the Add-modal lookups (TMDB for movies/TV, iTunes for podcasts) to find
// artwork for a title the model suggested. Doubles as a light grounding check:
...
export function lookupRecArtwork(rec, contentType) {
  ...
  if (contentType !== 'podcast' && !TMDB_ENABLED) return Promise.resolve(null);
